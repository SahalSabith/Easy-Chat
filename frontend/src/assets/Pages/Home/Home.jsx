...
const Home = () => {
  // Sample data for chat rooms - this would come from your Django backend
  const chatRooms = [
          ...
          {chatRooms.map(room => (
            <div key={room.id} className="room-card">
              <div className="room-header">
                ...
                <span className="room-participants">{room.participants} online</span>
              </div>
              <div className="room-host">Hosted by: {room.host}</div>
